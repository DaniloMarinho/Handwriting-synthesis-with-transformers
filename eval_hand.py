...
def load_pretrained_uncond():
    ...
    lr_model.load_state_dict(torch.load('saved_model/model_uncond.pt', map_location=device)['model'])
...
def load_pretrained_congen():
    ...
    lr_model.load_state_dict(torch.load('saved_model/model_congen.pt', map_location=device)['model'])
